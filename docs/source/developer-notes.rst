...
+===============================+=============================================+===================================================+===================================================+
| ``PDC obj create``            | Client - Metadata Server                    | Client - Metadata Server                          | Client - Metadata Server                          |
+-------------------------------+---------------------------------------------+---------------------------------------------------+---------------------------------------------------+
| ``PDC obj open``              | Client - Metadata Server                    | Client - Metadata Server                          | Client - Metadata Server                          |
+-------------------------------+---------------------------------------------+---------------------------------------------------+---------------------------------------------------+
| ``PDC region transfer start`` | Client - Data Server                        | Client - Data Server                              | Client - Data Server                              |
|                               | Client - Data Server                        | Client - Data Server                              | Client - Metadata Server (Option 1)               |
|                               | Client - Data Server                        | Client - Data Server                              | Data Server - Metadata Server (Option 2)          |
+-------------------------------+---------------------------------------------+---------------------------------------------------+---------------------------------------------------+
| ``PDC region transfer wait    | Data Server - Client (PDC_READ)             | Data Server - Client (PDC_READ)                   | Data Server - Client (PDC_READ)                   |
+-------------------------------+---------------------------------------------+---------------------------------------------------+---------------------------------------------------+
