#!/bin/bash
# Scale study: scale servers 1-8, fixed 256 clients, cache ON
NPARTICLES=8388608
STEPS=5
SLEEP_TIME=20
...
echo "### cache=ON: scale servers 1-8, fixed 256 clients ###"
for n_servers in 1 2 4 8; do
    for strategy in 0 1 2; do
        run_test $n_servers 256 $strategy
    done
done
