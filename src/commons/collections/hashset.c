...
size_t
hashset_num_items(hashset_t set)
{
    return set->nitems;
}

void
hashset_destroy(hashset_t set)
{
    if (set) {
        free(set->items);
    }
...
static int
hashset_add_member(hashset_t set, void *item)
{
...
int
hashset_add(hashset_t set, void *item)
{
...
int
hashset_remove(hashset_t set, void *item)
{
    size_t value = (size_t)item;
...
int
hashset_is_member(hashset_t set, void *item)
{
    size_t value = (size_t)item;
    size_t ii    = set->mask & (prime_1 * value);
...
hashset_itr_t
hashset_iterator(hashset_t set)
{
...
int
hashset_iterator_has_next(hashset_itr_t itr)
{
    size_t index;
...
int
hashset_iterator_next(hashset_itr_t itr)
{
...
size_t
hashset_iterator_value(hashset_itr_t itr)
{
