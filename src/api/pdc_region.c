                          ...
                          pdcid_t remote_reg)
{
    ...
    printf("transfer request create check obj ndim %d, dims [%lld, %lld, %lld], local_offset[0] = %lld, reg1->offset[0]\n",
           (int)p->obj_ndim, (long long int)p->obj_dims[0], (long long int)p->obj_dims[1],
           (long long int)p->obj_dims[2], (long long int) p->local_region_offset[0], (long long int) reg1->offset[0]);
