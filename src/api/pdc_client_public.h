...
perr_t  PDCobj_put_tag(pdcid_t obj_id, const char *tag_name, void *tag_value, size_t value_size);
...
perr_t  PDCcont_put_tag(pdcid_t cont_id, const char *tag_name, void *tag_value, size_t value_size);
