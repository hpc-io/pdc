...
PDC_server_timing_init()
{
    ...
    */
    ...
    buf_obj_map_timestamps                            = ptr; ptr++;
    buf_obj_unmap_timestamps                          = ptr; ptr++;
    obtain_lock_write_timestamps                      = ptr; ptr++;
    obtain_lock_read_timestamps                       = ptr; ptr++;
    release_lock_write_timestamps                     = ptr; ptr++;
    release_lock_read_timestamps                      = ptr; ptr++;
    release_lock_bulk_transfer_write_timestamps       = ptr; ptr++;
    release_lock_bulk_transfer_read_timestamps        = ptr; ptr++;
    release_lock_bulk_transfer_inner_write_timestamps = ptr; ptr++;
    release_lock_bulk_transfer_inner_read_timestamps  = ptr; ptr++;

    transfer_request_start_write_timestamps      = ptr; ptr++;
    transfer_request_start_read_timestamps       = ptr; ptr++;
    transfer_request_wait_write_timestamps       = ptr; ptr++;
    transfer_request_wait_read_timestamps        = ptr; ptr++;
    transfer_request_wait_write_bulk_timestamps  = ptr; ptr++;
    transfer_request_wait_read_bulk_timestamps   = ptr; ptr++;
    transfer_request_inner_write_bulk_timestamps = ptr; ptr++;
    transfer_request_inner_read_bulk_timestamps  = ptr; ptr++;
