...
int main(int argc, char **argv)
{
    ...
    PDCprop_set_obj_time_step(obj_prop1, rank       );
    ...
    PDCprop_set_obj_time_step(obj_prop2, rank       );
    ...
    PDCprop_set_obj_time_step(obj_prop3, rank       );
...
// PDCobj_encode(pdcid_t obj_id, int rank, obj_encode send)
#ifdef ENABLE_MPI
    obj_encode send;
    PDCobj_encode(obj1, 0, send);
    printf("id is %lld\n", send.meta_id);
    printf("ndim is %d\n", send.ndim);
#endif
/*
