...
main(int argc, char **argv)
{
    ...
    TASSERT((cont_id3 = PDCcont_get_id("c1", pdc_id)) > 0, "Call to PDCcont_get_id succeeded",
            "Call to PDCcont_get_id failed");
    // close containers
    TASSERT(PDCcont_close(cont_id3) >= 0, "Call to PDCcont_close succeeded", "Call to PDCcont_close failed");
