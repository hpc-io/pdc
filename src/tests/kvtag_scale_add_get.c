...
main(int argc, char *argv[])
{
    ...
    uint64_t     n_add_tag, my_add_tag, my_add_tag_s;
    uint64_t     n_query, my_query, my_query_s;
    uint64_t     i, v;
    ...
    n_add_tag  = atoui64(argv[3]);
    n_query    = atoui64(argv[4]);
