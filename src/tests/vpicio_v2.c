...
int main(int argc, char **argv)
{
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
	&x[0], region_x, obj_xx, region_xx, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &y[0], region_y, obj_yy, region_yy, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &z[0], region_z, obj_zz, region_zz, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &px[0], region_px, obj_pxx, region_pxx, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &py[0], region_py, obj_pyy, region_pyy, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &pz[0], region_pz, obj_pzz, region_pzz, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &id1[0], region_id1, obj_id11, region_id11, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
    ...
    ret = PDCbuf_map_transform_register("pdc_transform_compress",
        &id2[0], region_id2, obj_id22, region_id22, 0, INCR_STATE, DATA_OUT);
    if(ret < 0)
