/* Copyright @2012 by Justin Hines at Bitly under a very liberal license. See LICENSE in the source
 * distribution. */
...
/* counting_bloom_t *new_counting_bloom_from_file(unsigned int capacity, double error_rate, const char
 * *filename); */
counting_bloom_t *new_counting_bloom(unsigned int capacity, double error_rate);
counting_bloom_t *new_counting_bloom_from_file(unsigned int capacity, double error_rate);
...
/* scaling_bloom_t *new_scaling_bloom_from_file(unsigned int capacity, double error_rate, const char
 * *filename); */
scaling_bloom_t *new_scaling_bloom(unsigned int capacity, double error_rate);
scaling_bloom_t *new_scaling_bloom_from_file(unsigned int capacity, double error_rate);
