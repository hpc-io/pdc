...
6. cmake ../ -DBUILD_MPI_TESTING=ON -DBUILD_SHARED_LIBS=ON -DBUILD_TESTING=ON -DPDC_ENABLE_CHECKPOINT=ON -DCMAKE_INSTALL_PREFIX=$PDC_DIR -DPDC_ENABLE_MPI=ON -DPDC_TIMING=OFF -DPDC_SERVER_CACHE=OFF -DMERCURY_DIR=$MERCURY_DIR -DCMAKE_C_COMPILER=mpicc
7. make -j8
8. ctest
